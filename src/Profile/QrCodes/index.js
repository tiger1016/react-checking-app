...
class QrCodes extends React.PureComponent {
  constructor (props) {
    ...
    this.state = {
      ...
      qrcodeInfo: new (profileController.qrCodeStructGenerator())(this.props.qrcodes ? this.props.qrcodes.shipping_information : {}, this.props.qrcodes.to),
      qrcodeInfoRev: new (profileController.qrCodeStructGenerator())(this.props.qrcodes ? this.props.qrcodes.shipping_information : {}, this.props.qrcodes.to),
  ...
  componentWillReceiveProps (nextProps) {
    this.setState({
      ...
      qrcodeInfo: new (profileController.qrCodeStructGenerator())(nextProps.qrcodes ? nextProps.qrcodes.shipping_information : {}, nextProps.qrcodes.to),
      qrcodeInfoRev: new (profileController.qrCodeStructGenerator())(nextProps.qrcodes ? nextProps.qrcodes.shipping_information : {}, nextProps.qrcodes.to),
  ...
  cancelClick = () => {
    if (this.state.isEdit) {
      if (this.isStateChanged()) {
        appController.confirmDiscardChanges(() => { this.setState({ isEdit: false, qrcodeInfo: { ...this.state.qrcodeInfoRev } }) })
      } else {
  ...
  render () {
    ...
    return <div id='QrCodes' className='profile-section'>
      ...
      <div className='section-content'>
        ...
        <SaveCancel loading={this.props.profileIsLoading} noCancel disabled={this.state.errors.length > 0} cancelOnClick={this.cancelClick} saveOnClick={this.updateClick} saveText='Place Order' />
